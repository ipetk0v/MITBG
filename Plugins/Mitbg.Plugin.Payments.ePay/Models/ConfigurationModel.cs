...
namespace Nop.Plugin.Payments.ePay.Models
{
    public class ConfigurationModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Plugins.Payments.ePay.Fields.EnableDirectCreditCard")]
        public bool EnableDirectCreditCard { get; set; }
        public bool EnableDirectCreditCard_OverrideForStore { get; set; }

        [NopResourceDisplayName("Plugins.Payments.ePay.Fields.EnableCashOnDelivery")]
        public bool EnableCashOnDelivery { get; set; }
        public bool EnableCashOnDelivery_OverrideForStore { get; set; }
    }
}
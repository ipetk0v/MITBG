    ...
    public class PaymentEpayController : BasePaymentController
    {
        ...
        public ActionResult Configure()
        {
            ...
            var model = new ConfigurationModel
            {
                ...
                EnableDirectCreditCard = ePaySettings.EnableDirectCreditCard,
                EnableCashOnDelivery = ePaySettings.EnableCashOnDelivery,
            ...
            if (storeScope > 0)
            {
                ...
                model.EnableDirectCreditCard_OverrideForStore = _settingService.SettingExists(ePaySettings, x => x.EnableDirectCreditCard, storeScope);
        ...
        public ActionResult Configure(ConfigurationModel model)
        {
            ...
            ePayPaymentSettings.EnableDirectCreditCard = model.EnableDirectCreditCard;
            ePayPaymentSettings.EnableCashOnDelivery = model.EnableCashOnDelivery;
            ...
            if (model.EnableDirectCreditCard_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(ePayPaymentSettings, x => x.EnableDirectCreditCard, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(ePayPaymentSettings, x => x.EnableDirectCreditCard, storeScope);

            if (model.EnableCashOnDelivery_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(ePayPaymentSettings, x => x.EnableCashOnDelivery, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(ePayPaymentSettings, x => x.EnableCashOnDelivery, storeScope);

...
namespace Nop.Plugin.Payments.ePay
{
    ...
    public class EPayPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        /// </summary>
        /// <returns></returns>
        public string GetEpaylUrl(PaymentType paymentType)
        {
            const string sandboxUrl = "https://demo.epay.bg/";
            const string sandboxDirectCreditCardUrl = "https://devep2.datamax.bg/ep2/epay2_demo/";
            ...
            return _ePayPaymentSettings.UseSandbox ?
                (paymentType == PaymentType.DirectCreditCard ? sandboxDirectCreditCardUrl : sandboxUrl)
                : productionUrl;
        }
        ...
        {
            if (!_ePayPaymentSettings.EnableEasyPay && !_ePayPaymentSettings.EnableEpay && !_ePayPaymentSettings.EnableDirectCreditCard && !_ePayPaymentSettings.EnableCashOnDelivery)
            {
                return;
            }
            ...
            if (paymentMethod == PaymentType.CashOnDelivery)
            {

                return;
            }
            else if (paymentMethod == PaymentType.DirectCreditCard)
            {
                ...
                builder.Append(GetEpaylUrl(paymentMethod));
                builder.AppendFormat("?PAGE=credit_paydirect&encoded={0}&checksum={1}&url_ok={2}&url_cancel={3}", WebUtility.UrlEncode(encoded), EncodeHMACSHA1(encoded, _ePayPaymentSettings.SecretKey), returnUrl, cancelReturnUrl);

                _httpContextAccessor.HttpContext.Response.Redirect(builder.ToString());
            }
            else if (paymentMethod == PaymentType.Epay)
            {
                var returnUrl = _webHelper.GetStoreLocation(false) + "Plugins/PaymentEpay/PDTHandler";
                var cancelReturnUrl = _webHelper.GetStoreLocation(false) + "Plugins/PaymentEpay/CancelOrder";
        ...
        public override void Install()
        {
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.ePay.Fields.EnableDirectCreditCard", "Enable DirectCreditCard");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.ePay.Fields.EnableDirectCreditCard.Hint", "Check to enable the DirectCreditCard payment method.");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.ePay.Fields.CashOnDelivery", "Enable CashOnDelivery");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.Payments.ePay.Fields.CashOnDelivery.Hint", "Check to enable the CashOnDelivery payment method.");
        ...
        public override void Uninstall()
        {
            ...
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.ePay.Fields.EnableDirectCreditCard");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.ePay.Fields.EnableDirectCreditCard.Hint");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.ePay.Fields.EnableCashOnDelivery");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.ePay.Fields.EnableCashOnDelivery.Hint");
            ...
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.ePay.Fields.Configure.DirectCreditCard");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.ePay.Fields.Configure.CashOnDelivery");

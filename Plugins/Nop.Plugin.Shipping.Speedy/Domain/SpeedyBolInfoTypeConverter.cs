...
{
    public class SpeedyBolInfoTypeConverter : TypeConverter
    {
        /// <summary>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            SpeedyBolInfo bolInfo = null;

            try
            {
                using (var tr = new StringReader(valueStr))
                {
                    var xmlS = new XmlSerializer(typeof(SpeedyBolInfo));
                    bolInfo = (SpeedyBolInfo)xmlS.Deserialize(tr);
                }
            }
            catch
            {

...
namespace Nop.Plugin.Shipping.Speedy.Controllers
{
    public class SpeedyController : BasePluginController
    {
        ...
        public SpeedyController(
            ...
            ISpeedyContext speedyContext,
            IRepository<SpeedyShipment> speedyShipmentsRep,
        ...
        public IActionResult Configure()
        {
            ...
            return View("~/Plugins/Shipping.Speedy/Views/Configuration.cshtml", model);
        }
        ...
        public IActionResult ShipmentsList()
        {
            ...
            return View("~/Plugins/Shipping.Speedy/Views/ShipmentsList.cshtml", model);
        }
        ...
        {
            var shipmentsQuery = _speedyShipmentsRep.Table;
        ...
        {
            var customer = _workContext.CurrentCustomer;
            var bol = _speedyContext.GetBillInfo(customer.Id) ?? new SpeedyBolInfo();
        ...
        public async Task<ActionResult> SpeedyForm(FormViewModel model)
        {
            ...
            return View("~/Plugins/Shipping.Speedy/Views/_AddressForm.cshtml", model);
        }

        private async Task<List<SpeedyOffice>> LoadOfficies(int siteId)
        {
            using (var srv = GetSpeedyClient())
            {
                var sites = await srv.listOfficesExAsync(login.sessionId, "", siteId, paramLanguage.BG, 100);

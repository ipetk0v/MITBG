...
{
    public class SpeedyShipmentObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public SpeedyShipmentObjectContext(DbContextOptions<SpeedyShipmentObjectContext> options) : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfiguration(new SpeedyShipmentMap());
        ...
        {
            //drop the table
            this.DropPluginTable("SpeedyShipments");
        }
